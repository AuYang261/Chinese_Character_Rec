...
def efficientnetv2(num_classes: int = 1000, scale: str = "s"):
    if scale == "s":
        return efficientnetv2_s(num_classes)
    elif scale == "m":
        return efficientnetv2_m(num_classes)
    elif scale == "l":
        return efficientnetv2_l(num_classes)
    else:
        raise ValueError("Unknown EfficientNetV2 scale.")
